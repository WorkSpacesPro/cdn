...
$(function(){
	...
	rightNav += "<li><a href='https://whois.dami.pub/' target='_blank'>Whois查询</a></li>";
    rightNav += "<li><a href='https://dami.pub/blog' target='_blank'>域名博客</a></li>";
    rightNav += "<li><a href='https://dami.pub/lianmeng' target='_blank'>米表联盟</a></li>";
    rightNav += "<li><a href='https://dami.pub' target='_blank'>域名导航</a></li>";
    rightNav += "<hr>";
    rightNav += "<li class='qrBtn'><a href='./weixin.html' target='_blank'>微信联系</a></li>";
    rightNav += "<li class='qrBox'><img src='./images/ewm01.jpg' alt='微信二维码'/></li>";
    rightNav += "</ul>";
...
function scrollPlus()
{
    ...
    function make_boxes()
    {
        if (!b)
        {
            ...
            b.setAttribute("style", "width:21px;background:url(https://www.qijishow.com/down/assets/images/snav_icon.png) 15px 10px no-repeat rgb(47, 53, 76);min-height:30px;text-align:center;border-top-left-radius: 100px;padding: 6px 8px 0px 17px;border-bottom-left-radius: 100px;position: fixed; top: -40px; right: 0;overflow: hidden; z-index: 102400;font-family:Arial !important;cursor:n-resize;cursor:ns-resize;");
